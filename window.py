...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("images/UI/yy.jpg"))
        # 图片读取进程
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        about_title = QLabel('欢迎使用口罩检测系统\n\n ')
        about_title.setFont(QFont('楷体', 18))
        about_title.setAlignment(Qt.AlignCenter)
        about_img = QLabel()
        about_img.setPixmap(QPixmap('images/UI/wx.jpg'))
        about_img.setAlignment(Qt.AlignCenter)

        # label4.setText("<a href='https://oi.wiki/wiki/学习率的调整'>如何调整学习率</a>")
        label_super = QLabel()  # todo 更换作者信息
        label_super.setText("<a href='https://blog.csdn.net/weixin_45626338?type=blog'>或者你可以在这里找到我-->李天祥</a>")
        ...
        self.setTabIcon(0, QIcon('images/UI/yy.jpg'))
        self.setTabIcon(1, QIcon('images/UI/yy.jpg'))
        self.setTabIcon(2, QIcon('images/UI/yy.jpg'))
